...
protocol FoundationTableViewCellDelegate {
    func didTapLink(tableViewCell: UITableViewCell, label: TTTAttributedLabel)
    //お気に入り登録
    func didTapLikeButton(tableViewCell: UITableViewCell, button: UIButton)
}

class FoundationTableViewCell: UITableViewCell, TTTAttributedLabelDelegate {
    
    var delegate: FoundationTableViewCellDelegate?
